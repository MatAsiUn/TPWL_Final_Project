...
- Archie
Completed the setup of Riesz Representation theorem (Outline 1-3). Proved Pythagorus Theorem and completed the proof for the polarization identity (Mike wrote the statement, I wrote the proof), and proved the Ptolemy inequality. Proved a corrollary of Riesz that states that elements of the dual space attain their norms.
